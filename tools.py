...
def get_skin_type_info(skin_type: str) -> dict:
    ...
    Args: 
        ...
        Returns a dictionary list of characteristics, as well as recommended ingredients
        and ingredients to avoid for that skin type.
    Example:
...
def get_hair_type_info(hair_type: str) -> dict:
    ...
    Args: 
        ...
        Returns a dictionary list of characteristics, as well as recommended ingredients
        and ingredients to avoid for that hair type.
    Example:
...
def product_search(product_type: str, skin_or_hair_type: str) -> list:
